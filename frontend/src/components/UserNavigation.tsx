...
const userNavigation = [
  ...
  { name: 'Recharge Card', href: '/recharge', icon: Wallet },
  { name: 'Recharge History', href: '/recharge-history', icon: CreditCard },
  { name: 'Travel History', href: '/travel-history', icon: History },
];
          ...
          <div className="flex items-center gap-2 font-semibold flex-1">
            ...
            {!isCollapsed && (
              <div>
                ...
                <Badge variant="secondary" className="ml-2 text-xs">USER</Badge>
              </div>
            )}
          </div>
          <Button
